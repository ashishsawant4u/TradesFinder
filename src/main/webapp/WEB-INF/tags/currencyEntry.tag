...
<div class="row ps-0" id="cur_buySellToggleDiv">
	<div class="btn-group" role="group" aria-label="Basic radio toggle button group">
	  ...
	  <label class="btn btn-outline-danger cursor-pointer" for="cur_btnradioShortSell">SHORT SELL</label>
	</div>
</div>
</div>

<div class="row pt-1 theme1 pb-1">
...
<div class="row pt-1 pb-1">
 <div class="col-md-8 ps-0">
 		<button type="button" class="btn btn-primary" id="cur_TradeCalBtn">Calculate Trade</button>
 </div>
 <div class="col-md-4">
    <div class="input-group">
